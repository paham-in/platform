...
part of 'tutoring_upload_session_evidence_response.dart';
...
_$TutoringUploadSessionEvidenceResponseFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      'TutoringUploadSessionEvidenceResponse',
      json,
      ($checkedConvert) {
        final val = TutoringUploadSessionEvidenceResponse(
...
Map<String, dynamic> _$TutoringUploadSessionEvidenceResponseToJson(
  TutoringUploadSessionEvidenceResponse instance,
) => <String, dynamic>{
