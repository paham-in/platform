...
part of 'user_admin_create_user_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

UserAdminCreateUserResponse _$UserAdminCreateUserResponseFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'UserAdminCreateUserResponse',
  json,
  ($checkedConvert) {
    final val = UserAdminCreateUserResponse(
...
Map<String, dynamic> _$UserAdminCreateUserResponseToJson(
  UserAdminCreateUserResponse instance,
) => <String, dynamic>{
