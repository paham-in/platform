...
part of 'tutoring_admin_toggle_fee_paid_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TutoringAdminToggleFeePaidResponse _$TutoringAdminToggleFeePaidResponseFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'TutoringAdminToggleFeePaidResponse',
  json,
  ($checkedConvert) {
    final val = TutoringAdminToggleFeePaidResponse(
...
Map<String, dynamic> _$TutoringAdminToggleFeePaidResponseToJson(
  TutoringAdminToggleFeePaidResponse instance,
) => <String, dynamic>{
