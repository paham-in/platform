...
part 'user_admin_list_users_response.g.dart';
...
class UserAdminListUsersResponse {
  /// Returns a new [UserAdminListUsersResponse] instance.
  UserAdminListUsersResponse({
  ...
  final List<UserSubjectInfo>? subjects;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is UserAdminListUsersResponse &&
  ...
  factory UserAdminListUsersResponse.fromJson(Map<String, dynamic> json) => _$UserAdminListUsersResponseFromJson(json);

  Map<String, dynamic> toJson() => _$UserAdminListUsersResponseToJson(this);
