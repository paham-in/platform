...
part 'user_admin_create_user_response.g.dart';
...
class UserAdminCreateUserResponse {
  /// Returns a new [UserAdminCreateUserResponse] instance.
  UserAdminCreateUserResponse({
  ...
  final List<UserSubjectInfo>? subjects;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is UserAdminCreateUserResponse &&
  ...
  factory UserAdminCreateUserResponse.fromJson(Map<String, dynamic> json) => _$UserAdminCreateUserResponseFromJson(json);

  Map<String, dynamic> toJson() => _$UserAdminCreateUserResponseToJson(this);
