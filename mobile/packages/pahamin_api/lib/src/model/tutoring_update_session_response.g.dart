...
part of 'tutoring_update_session_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TutoringUpdateSessionResponse _$TutoringUpdateSessionResponseFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'TutoringUpdateSessionResponse',
  json,
  ($checkedConvert) {
    final val = TutoringUpdateSessionResponse(
...
Map<String, dynamic> _$TutoringUpdateSessionResponseToJson(
  TutoringUpdateSessionResponse instance,
) => <String, dynamic>{
