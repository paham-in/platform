...
part of 'user_admin_list_users_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

UserAdminListUsersResponse _$UserAdminListUsersResponseFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'UserAdminListUsersResponse',
  json,
  ($checkedConvert) {
    final val = UserAdminListUsersResponse(
...
Map<String, dynamic> _$UserAdminListUsersResponseToJson(
  UserAdminListUsersResponse instance,
) => <String, dynamic>{
