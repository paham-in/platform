...
part of 'tutoring_admin_list_fees_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TutoringAdminListFeesResponse _$TutoringAdminListFeesResponseFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'TutoringAdminListFeesResponse',
  json,
  ($checkedConvert) {
    final val = TutoringAdminListFeesResponse(
...
Map<String, dynamic> _$TutoringAdminListFeesResponseToJson(
  TutoringAdminListFeesResponse instance,
) => <String, dynamic>{
