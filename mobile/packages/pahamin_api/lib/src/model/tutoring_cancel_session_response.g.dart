...
part of 'tutoring_cancel_session_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TutoringCancelSessionResponse _$TutoringCancelSessionResponseFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'TutoringCancelSessionResponse',
  json,
  ($checkedConvert) {
    final val = TutoringCancelSessionResponse(
...
Map<String, dynamic> _$TutoringCancelSessionResponseToJson(
  TutoringCancelSessionResponse instance,
) => <String, dynamic>{
