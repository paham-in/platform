...
part of 'tutoring_admin_create_booking_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TutoringAdminCreateBookingResponse _$TutoringAdminCreateBookingResponseFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'TutoringAdminCreateBookingResponse',
  json,
  ($checkedConvert) {
    final val = TutoringAdminCreateBookingResponse(
...
Map<String, dynamic> _$TutoringAdminCreateBookingResponseToJson(
  TutoringAdminCreateBookingResponse instance,
) => <String, dynamic>{
