...
part of 'tutoring_admin_list_evidence_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TutoringAdminListEvidenceResponse _$TutoringAdminListEvidenceResponseFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'TutoringAdminListEvidenceResponse',
  json,
  ($checkedConvert) {
    final val = TutoringAdminListEvidenceResponse(
...
Map<String, dynamic> _$TutoringAdminListEvidenceResponseToJson(
  TutoringAdminListEvidenceResponse instance,
) => <String, dynamic>{
