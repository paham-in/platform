...
part of 'tutoring_list_bookings_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TutoringListBookingsResponse _$TutoringListBookingsResponseFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'TutoringListBookingsResponse',
  json,
  ($checkedConvert) {
    final val = TutoringListBookingsResponse(
...
Map<String, dynamic> _$TutoringListBookingsResponseToJson(
  TutoringListBookingsResponse instance,
) => <String, dynamic>{
