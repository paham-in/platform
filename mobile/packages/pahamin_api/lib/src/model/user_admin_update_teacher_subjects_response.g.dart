...
part of 'user_admin_update_teacher_subjects_response.dart';
...
_$UserAdminUpdateTeacherSubjectsResponseFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      'UserAdminUpdateTeacherSubjectsResponse',
      json,
      ($checkedConvert) {
        final val = UserAdminUpdateTeacherSubjectsResponse(
...
Map<String, dynamic> _$UserAdminUpdateTeacherSubjectsResponseToJson(
  UserAdminUpdateTeacherSubjectsResponse instance,
) => <String, dynamic>{
