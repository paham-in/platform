...
part of 'tutoring_assign_teacher_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TutoringAssignTeacherResponse _$TutoringAssignTeacherResponseFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'TutoringAssignTeacherResponse',
  json,
  ($checkedConvert) {
    final val = TutoringAssignTeacherResponse(
...
Map<String, dynamic> _$TutoringAssignTeacherResponseToJson(
  TutoringAssignTeacherResponse instance,
) => <String, dynamic>{
