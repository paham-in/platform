...
part of 'tutoring_list_sessions_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TutoringListSessionsResponse _$TutoringListSessionsResponseFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'TutoringListSessionsResponse',
  json,
  ($checkedConvert) {
    final val = TutoringListSessionsResponse(
...
Map<String, dynamic> _$TutoringListSessionsResponseToJson(
  TutoringListSessionsResponse instance,
) => <String, dynamic>{
