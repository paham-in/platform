...
part of 'tutoring_admin_list_bookings_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TutoringAdminListBookingsResponse _$TutoringAdminListBookingsResponseFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'TutoringAdminListBookingsResponse',
  json,
  ($checkedConvert) {
    final val = TutoringAdminListBookingsResponse(
...
Map<String, dynamic> _$TutoringAdminListBookingsResponseToJson(
  TutoringAdminListBookingsResponse instance,
) => <String, dynamic>{
