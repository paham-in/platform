...
part of 'user_update_profile_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

UserUpdateProfileResponse _$UserUpdateProfileResponseFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'UserUpdateProfileResponse',
  json,
  ($checkedConvert) {
    final val = UserUpdateProfileResponse(
...
Map<String, dynamic> _$UserUpdateProfileResponseToJson(
  UserUpdateProfileResponse instance,
) => <String, dynamic>{
