...
part 'user_admin_update_teacher_subjects_response.g.dart';
...
class UserAdminUpdateTeacherSubjectsResponse {
  /// Returns a new [UserAdminUpdateTeacherSubjectsResponse] instance.
  UserAdminUpdateTeacherSubjectsResponse({
  ...
  final List<UserSubjectInfo>? subjects;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is UserAdminUpdateTeacherSubjectsResponse &&
  ...
  factory UserAdminUpdateTeacherSubjectsResponse.fromJson(Map<String, dynamic> json) => _$UserAdminUpdateTeacherSubjectsResponseFromJson(json);

  Map<String, dynamic> toJson() => _$UserAdminUpdateTeacherSubjectsResponseToJson(this);
