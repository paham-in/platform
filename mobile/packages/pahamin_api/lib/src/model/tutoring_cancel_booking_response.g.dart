...
part of 'tutoring_cancel_booking_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TutoringCancelBookingResponse _$TutoringCancelBookingResponseFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'TutoringCancelBookingResponse',
  json,
  ($checkedConvert) {
    final val = TutoringCancelBookingResponse(
...
Map<String, dynamic> _$TutoringCancelBookingResponseToJson(
  TutoringCancelBookingResponse instance,
) => <String, dynamic>{
