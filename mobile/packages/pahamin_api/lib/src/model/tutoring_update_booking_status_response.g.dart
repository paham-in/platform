...
part of 'tutoring_update_booking_status_response.dart';
...
_$TutoringUpdateBookingStatusResponseFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      'TutoringUpdateBookingStatusResponse',
      json,
      ($checkedConvert) {
        final val = TutoringUpdateBookingStatusResponse(
...
Map<String, dynamic> _$TutoringUpdateBookingStatusResponseToJson(
  TutoringUpdateBookingStatusResponse instance,
) => <String, dynamic>{
