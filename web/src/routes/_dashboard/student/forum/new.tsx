...
navigate({ to: "/student/forum", replace: true })
  ...
  const submit = (v: { content: string; subject_id: string }) => {
    createQuestion({
      body: {
        content: v.content,
        subject_id: v.subject_id ? Number(v.subject_id) : undefined,
      },
    })
  }
