...
export default defineConfig({
  ...
  // Matikan "bundled dev" rolldown (experimental.bundledDev). Mode ini menyuntik
  // __BUNDLED_DEV__ = true sehingga HMR memakai jalur __rolldown_runtime__
  // yang belum kompatibel dengan TanStack Router, memunculkan error
  // "Cannot read properties of undefined (reading 'get')" saat route di-reload.
  experimental: {
    bundledDev: false,
  },
  resolve: {
