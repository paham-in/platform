...
// `public/quiz_questions/<uuid>.<ext>` (gambar paket soal),
...
var ContentImageRe = regexp.MustCompile(`(?:https?://[^"'\s]+/)?((?:public/(?:materials|quiz_questions|questions|forum_questions|temp_[a-z_]+)|forum)/[0-9a-fA-F-]+\.(?:jpg|jpeg|png|gif|webp))(?:\?[^"'\s]*)?`)
