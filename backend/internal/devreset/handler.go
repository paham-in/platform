...
var tables = []tableDef{
	...
	{name: "forum_questions", label: "Pertanyaan", desc: "Pertanyaan forum tanya jawab"},
	{name: "forum_answers", label: "Jawaban", desc: "Jawaban forum tanya jawab"},
	{name: "forum_question_assets", label: "Asset Pertanyaan", desc: "Asset/gambar pada pertanyaan forum"},
	...
	{name: "refund_claims", label: "Klaim Refund", desc: "Utang refund per sesi"},
	...
	{name: "quiz_questions", label: "Soal Bank", desc: "Soal paket soal"},
	{name: "quiz_answers", label: "Jawaban Bank", desc: "Jawaban soal paket"},
	{name: "quiz_packages", label: "Paket Soal", desc: "Paket soal"},
	{name: "quiz_collections", label: "Koleksi Paket Soal", desc: "Koleksi paket soal per kelas"},
	{name: "quiz_question_assets", label: "Asset Soal", desc: "Asset/gambar pada soal paket"},
	{name: "quiz_answer_assets", label: "Asset Jawaban Paket", desc: "Asset/gambar pada jawaban paket soal"},
