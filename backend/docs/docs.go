...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/dev/cron/cancelled-booking-cleanup": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/tutoring/bookings/{id}/extend": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/tutoring/bookings/{id}/refund-claims": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/tutoring.BookingRefundClaimResponse"
                            }
                        }
                    },
                    "400": {
        ...
        "/admin/tutoring/bookings/{id}/sessions": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "tutoring.BookingRefundClaimResponse": {
            "type": "object",
            "properties": {
                "amount": {
                    "type": "number"
        ...
        "tutoring.ExtendBookingRequest": {
            "type": "object",
            "properties": {
                "additional_sessions": {
                    "description": "sesi tambahan, wajib kelipatan sesi/minggu",
                    "type": "integer"
                }
            }
        },
        "tutoring.ExtendBookingResponse": {
            "type": "object",
            "properties": {
                "added_amount": {
                    "type": "number"
