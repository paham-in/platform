...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/dev/cron/payment-proof-cleanup": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "patch": {
                ...
                "responses": {
                    ...
                    "403": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/paymentproof.ErrorResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
        ...
        "/invoices/{invoice_id}/proof": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/paymentproof.ProofDetail"
                            }
                        }
                    }
                }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "Foto bukti transfer (jpg, png, gif, webp, max 5MB)",
                        "name": "image",
                        "in": "formData",
                        "required": true
                    }
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/paymentproof.UploadResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "paymentproof.ProofDetail": {
            ...
            "properties": {
                ...
                "url": {
                    "description": "presigned, kosong untuk pending",
                    "type": "string"
                }
            }
        },
        "paymentproof.UploadResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
